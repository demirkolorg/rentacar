...
exports.get = async (req, res) => {
  ...
  try {
    ...
    return response.success(
      ...
      pt.types.get,
      messages.basarili,
      messages.pozisyon_get_basarili
    );
  } catch (err) {
...
exports.getAll = async (req, res) => {
  ...
  try {
    ...
    return response.success(
      ...
      pt.types.get,
      messages.basarili,
      messages.pozisyon_getall_basarili
    );
  } catch (err) {
    return response.error(res);
  }
...
exports.add = async (req, res) => {
  ...
  try {
    ...
    return response.success(
      ...
      pt.types.create,
      messages.basarili,
      messages.pozisyon_create_basarili
    );
  } catch (err) {
    if (err.code === 11000) {
...
exports.update = async (req, res) => {
  ...
  try {
    ...
    return response.success(
      ...
      pt.types.update,
      messages.basarili,
      messages.pozisyon_update_basarili
    );
  } catch (err) {
    if (err.code === 11000) {
      return response.error(res, 'Bu pozisyon adı zaten kullanılmakta.', 'Veri Hatası', 409);
...
exports.delete = async (req, res) => {
  ...
  try {
    ...
    return response.success(
      ...
      pt.types.delete,
      messages.basarili,
      messages.pozisyon_delete_basarili
    );
  } catch (err) {
    return response.error(res);
  }
...
exports.durumDegistir = async (req, res) => {
  ...
  try {
    ...
    return response.success(
      ...
      pt.types.update,
      messages.basarili,
      messages.pozisyon_durum_basarili
    );
  } catch (err) {
    return response.error(res);
  }
