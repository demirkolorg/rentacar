  ...
  return (
    <div className="md:flex items-center">
      <div className="flex-none">
        <h4 className="text-slate-600 dark:text-slate-200 text-sm font-normal mb-[6px]">Total earnings</h4>
        {filterMap === 'usa' && (
          <div className="text-lg font-medium mb-[6px] dark:text-white text-slate-900">$12,65,64787.00</div>
        )}
        {filterMap === 'global' && (
          <div className="text-lg font-medium mb-[6px] dark:text-white text-slate-900">$12,65.00</div>
        )}
